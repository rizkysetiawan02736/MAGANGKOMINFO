		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="number" name="id_user" value="<?php echo $Agenda->id_user ?>" required class="form-control"/>
				</div>
                ...
                <div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" name="disposisi" value="<?php echo $Agenda->disposisi ?>" required class="form-control"/>
				</div>
